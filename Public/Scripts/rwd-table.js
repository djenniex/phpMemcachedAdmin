  ...
  $.widget( "filament.table", { // need to come up with a better namespace var...
    ...
    _create: function() {
      var self = this,
            ...
            container = o.checkContainer ? $(o.checkContainer) : $('<div class="btn-group"><button type="button" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">Display <span class="caret"></span></button><ul class="dropdown-menu" role="menu"></ul></div>');
